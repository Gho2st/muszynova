...
const CookieConsent = () => {
  ...
  // Ładowanie Facebook Pixel (tylko gdy zgoda na ad_storage)
  ...
  useEffect(() => {
    ...
    if (storedConsent) {
      ...
      // Pixel ładujemy tylko jeśli była zgoda na reklamy
  ...
  const saveConsent = (newConsent) => {
    ...
    // 2. Obsłuż Facebook Pixel osobno (bo nie jest częścią Consent Mode)
