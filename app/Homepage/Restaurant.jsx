...
export default function Restaurant() {
  return (
    <section className="bg-[#C4966C] px-6 xl:px-44 py-20 text-white">
      <h2 className="text-5xl text-center font-extrabold text-white mb-6">
        Restauracja Muszynova
      </h2>
      <div className="text-white text-center xl:w-3/4 mx-auto">
          ...
          <div>
            <div className="flex items-center justify-end gap-10">
              <Image
                ...
                alt=""
              />
              <h3 className="text-2xl font-semibold">Lokalne Składniki</h3>
            </div>
          ...
          <div>
            <div className="flex items-center justify-end gap-10">
              <Image
                ...
                alt=""
              />
              <h3 className="text-2xl font-semibold">Dziecięce Smaki</h3>
            </div>
            <p className="font-light ">
          ...
          <div>
            <div className="flex items-center justify-end gap-10">
              <Image
                ...
                alt=""
              />
              <h3 className="text-2xl font-semibold">NOve standardy</h3>
            </div>
            <p className="font-light ">
          ...
          <div>
            <div className="flex items-center flex-row-reverse  gap-10">
              <Image
                ...
                alt=""
              />
              <h3 className="text-2xl font-semibold">Zdrowszy wybór</h3>
            </div>
            <p className="font-light ">
          ...
          <div>
            <div className="flex items-center flex-row-reverse  gap-10">
              <Image
                ...
                alt=""
              />
              <h3 className="text-2xl font-semibold">Dla dorosłych</h3>
            </div>
            <p className="font-light ">
